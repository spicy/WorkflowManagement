        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Services_Processes_ProcessId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkOrderPackages", x => x.Id);
                    table.ForeignKey(
                        name: "FK_WorkOrderPackages_Packages_PackageId",
                        column: x => x.PackageId,
                        principalTable: "Packages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_WorkOrderPackages_WorkOrders_WorkOrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_ProcessId",
                table: "Services",
                column: "ProcessId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderPackages_PackageId",
                table: "WorkOrderPackages",
                column: "PackageId");

            migrationBuilder.CreateIndex(
                name: "IX_WorkOrderPackages_WorkOrderId",
                table: "WorkOrderPackages",
                column: "WorkOrderId");
